...
public class ProductsControllerTest {
    ...
    private static final String RESOURCE_LOCATION_PATTERN = "http://localhost/example/v1/products/[0-9]+";
    ...
    public void shouldHaveEmptyDB() throws Exception {
        mvc.perform(get("/example/v1/products")
    ...
    public void shouldCreateRetrieveDelete() throws Exception {
        Products r1 = mockProducts("shouldCreateRetrieveDelete");
        byte[] r1Json = toJson(r1);

        //CREATE
        MvcResult result = mvc.perform(post("/example/v1/products")
                .content(r1Json)
        ...
        //RETRIEVE
        mvc.perform(get("/example/v1/products/" + id)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
        ...
        //DELETE
        mvc.perform(delete("/example/v1/products/" + id))
 ...
 */
    ...
    public void shouldCreateAndUpdateAndDelete() throws Exception {
        Products r1 = mockProducts("shouldCreateAndUpdate");
        byte[] r1Json = toJson(r1);
        //CREATE
        MvcResult result = mvc.perform(post("/example/v1/products")
                .content(r1Json)
        ...
        Products r2 = mockProducts("shouldCreateAndUpdate2");
        r2.setId(id);
        byte[] r2Json = toJson(r2);

        //UPDATE
        result = mvc.perform(put("/example/v1/products/" + id)
                .content(r2Json)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent())
    ...
    ******************************
    ...
    private Products mockProducts(String prefix) {
